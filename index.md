# momst ![momst logo](reference/figures/logo.png)

`momst` is the **reference R implementation** of the Multi-Criteria
Minimum Spanning Tree (mc-MST) solver introduced in:
...
> on Evolutionary Computation (CEC)**, pp. 1818 to 1825. IEEE.
...
2.  **Comparing the Four MO-MST Variants**: side by side comparison of
    the four solver variants on the same instance, with combined Pareto
    front and runtime analysis.
